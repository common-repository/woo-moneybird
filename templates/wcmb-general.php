 ...
 ?>
 <div class="wrap">
	<h1><?php _e('MoneyBird General Settings', 'wcmb' ); ?></h1>
	<?php
		if(get_option('wcmb_moneybird_access_token') == ""){
			$MoneybirdApiSetting = admin_url('admin.php?page=moneybird-settings-page');
			?>
			<div class="error">
                <p><strong>ERROR :</strong><?php _e('Please Get Access token Process complite.<br />Go to Moneybird API setting', 'wcmb' );?> :  <a href="<?php echo $MoneybirdApiSetting;?>">Moneybird API Setting</a></p>
            </div>
			<?php
		} else {
		?>	
			<form method="post" id="wcmb_mb_General_setting_form">
	            <table class="form-table">
	                <tbody>
	                    <tr valign="top">
	                        <th scope="row">
	                            <label><?php _e('Moneybird Document Style', 'wcmb' ); ?></label>
	                        </th>
	                        <td>
	                        	<?php
	                            	...
	                            	echo '<select name="wcmb_invoice_layout" class="textBoxWidth" id="wcmb_invoice_layout" >';
	                    ...
	                    <tr valign="top">
	                        <th scope="row">
	                            <label><?php _e('Moneybird Workflow', 'wcmb' ); ?></label>
	                        </th>
	                        <td>
	                        	<?php
							        // workflow id get
	                            	...
	                            	echo '<select name="wcmb_workflow" class="textBoxWidth" id="wcmb_workflow">';
	                    ...
	                    <tr valign="top">
	                        ...
	                        <td>
	                            ...
	                            <p class="submit"><input type="submit" name="wcmb_save_general_setting" id="wcmb_save_invoice_layout" class="button button-primary" value="<?php _e('Save Changes'	)?>"></p>                        
	                        </td>
                    	</tr>
	                </tbody>
	            </table>
